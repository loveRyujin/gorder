module github.com/loveRyujin/gorder/payment

go 1.25.4

replace github.com/loveRyujin/gorder/common => ../common

// 解决 genproto 版本冲突：排除所有旧版本的 genproto 模块，统一使用新的模块化版本
// 旧版本的 genproto 已经被拆分为多个独立的模块（如 google.golang.org/genproto/googleapis/api）
...
require (
	...
	github.com/loveRyujin/gorder/common v0.0.0-00010101000000-000000000000
